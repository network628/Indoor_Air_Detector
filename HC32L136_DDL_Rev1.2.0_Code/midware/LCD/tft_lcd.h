...
//#define LCD_RST_PIN    GPIO_Pin_12	 //RST 对应单片机引脚定义 P3^3 / 对应STM32的 PA11
#define LCD_RD_PIN     GpioPin10	 //RD  对应单片机引脚定义 P2^6 / 对应STM32的 PB1
#define LCD_WR_PIN     GpioPin11	 //WR  对应单片机引脚定义 P2^5 / 对应STM32的 PB2
#define LCD_RS_PIN     GpioPin12   //RS  对应单片机引脚定义 P3^2 / 对应STM32的 PA8
#define LCD_CS_PIN     GpioPin15	 //CS  对应单片机引脚定义 P2^7 / 对应STM32的 PB0
...
//PC0~15,作为数据口
#define DATAOUT(x) Gpio_SetClrPort(GpioPortB, ((x )<<16)|~(x )); //GPIOB->ODR=x; //数据输出
#define DATAIN     (Gpio_GetInputData(GpioPortB)); //GPIOB->IDR;   //数据输入
...
#define DeepGray         0xad55 //深灰色
//GUI颜色
#define DeepColor        0x18e6 //深色背景
